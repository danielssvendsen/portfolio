...
window.I18N.no = {
  ...
  intro: {
    ...
    note: "Denne nettsiden er i hovedsak en glorifisert CV og fungerer også som slutt prosjektet for min CS50X-sertifisering.",
    cta_prefix: "Du kan laste ned",
    cta_suffix: "her eller navigere rundt på siden for mer informasjon. 🙂",
    cv_link: "min CV"
  },
  ...
  exp: {
    ...
    tussa: {
      role: "IT Konsulent",
      org: "Tussa · Heltid",
      meta1: "Aug 2024 – Okt 2024 · 3 md",
      meta2: "Ålesund, Møre og Romsdal, Norway · På stedet",
      bullets: [
    ...
    sunncom: {
      ...
      org: "Sunncom AS · Heltid",
      meta1: "Oct 2022 – Jan 2023 · 4 md",
      meta2: "Ålesund, Møre og Romsdal, Norway · På stedet",
      bullets: [
    ...
    alesund_2020: {
      ...
      org: "Ålesund Data AS · Heltid",
      meta1: "Okt 2020 – Sep 2022 · 2 år",
      meta2: "Hybrid",
      bullets: [
    ...
    alesund_2015: {
      role: "IT-konsulent",
      org: "Ålesund Data AS · Heltid",
      meta1: "Sep 2015 – Sep 2018 · 3 år 1 md",
      meta2: "På stedet",
      bullets: [
    ...
    alesund_2013: {
      role: "IT-tekniker",
      org: "Ålesund Data AS",
      meta1: "Jun 2013 – Aug 2014 · 1 år 3 md",
      meta2: "På stedet",
      bullets: [
    ...
    proservice: {
      ...
      org: "Proservice AS · Heltid",
      meta1: "Jul 2010 – Jan 2013 · 2 åd 7 md",
      meta2: "Ålesund, Møre og Romsdal, Norway · På stedet",
      bullets: [
    ...
    coop: {
      ...
      org: "Coop Prix · Deltid",
      meta1: "Jan 2008 – Jan 2009 · 1 åd 1 md",
  ...
  cert: {
    ...
    "003_line4": "Legitimasjons ID 7244118314DS",
